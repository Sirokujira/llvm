//===-- RX600InstrInfo.h - RX600 Instruction Information ----------*- C++ -*-===//
//
...
class RX600InstrInfo : public RX600GenInstrInfo {
  RX600TargetMachine &TM;
  const RX600RegisterInfo RI;
public:
  explicit RX600InstrInfo(RX600TargetMachine &TM);
