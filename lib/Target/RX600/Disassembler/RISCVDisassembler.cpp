...
extern "C" void LLVMInitializeRX600Disassembler() {
  ...
  TargetRegistry::RegisterMCDisassembler(getTheRX60032Target(),
                                         createRX600Disassembler);
  TargetRegistry::RegisterMCDisassembler(getTheRX60064Target(),
                                         createRX600Disassembler);
}
...
DecodeStatus RX600Disassembler::getInstruction(MCInst &MI, uint64_t &Size,
  ...
  if ((Bytes[0] & 0x3) == 0x3) {
    ...
    LLVM_DEBUG(dbgs() << "Trying RX60032 table :\n");
    ...
    if (!STI.getFeatureBits()[RX600::Feature64Bit]) {
      LLVM_DEBUG(
          dbgs() << "Trying RX60032Only_16 table (16-bit Instruction):\n");
      // Calling the auto-generated decoder function.
      Result = decodeInstruction(DecoderTableRX60032Only_16, MI, Insn, Address,
                                 this, STI);
